...
public final class TimeOperations {
	 ...
	 *            the Time Formatter
     * @param userDefined
     *            indicates that a user-defined <code>TimeFormatter</code> is supplied (<code>true</code>)
     *            or a default <code>TimeFormatter</code> is assigned (<code>false</code>). Default 
     *            <code>TimeFormatter</code>s (e.g. as set up when an <code>Experiment</code> object
     *            is created) will not overwrite a <code>TimeFormatter</code> potentially previously
     *            set the the user by calling <code>Experiment.setTimeFormatter(...)</code>.    
	 */
	static void setTimeFormatter(TimeFormatter myTimeFormatter, boolean userDefined) {
